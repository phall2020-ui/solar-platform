...
from app.page_registry import PAGE_GROUPS, SPECIAL_PAGES, get_visible_pages
...
try:
    from app.components.auth_ui import render_user_menu
    from app.components.notifications_ui import render_notification_badge
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        try:
            from app.components.job_monitor import job_monitor_sidebar
