...
from solar_platform.core.clients.huawei import REGIONS, base_url as huawei_base_url, login as huawei_login
...
class HuaweiClient(BaseInverterClient):
    ...
    REGIONS = REGIONS  # re-exposed for backward compatibility
    ...
    def __init__(self, config: dict):
        ...
        self.base_url = huawei_base_url(region)
    ...
    def authenticate(self) -> bool:
        ...
        try:
            self._xsrf_token = huawei_login(
                self.base_url, self.username, self.password, session=self.session
            )
