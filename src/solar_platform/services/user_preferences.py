...
# Module-level singleton (framework-agnostic)
_preferences_instance: UserPreferences | None = None


def init_preferences(db_path: str, user_id: str = "default") -> UserPreferences:
    """Initialize the global preferences singleton."""
    global _preferences_instance
    _preferences_instance = UserPreferences(db_path, user_id)
