...
class TestTariffType:
    def test_fixed(self):
        from services.financial.revenue import TariffType
...
class TestRevenueResult:
    def test_defaults(self):
        from services.financial.revenue import RevenueResult, TariffType
...
class TestRevenueService:
    ...
    def test_calculate_monthly_basic(self, mock_get_engine):
        ...
        from services.financial.revenue import RevenueService
    ...
    def test_calculate_monthly_preserves_tariff_type(self, mock_get_engine):
        ...
        from services.financial.revenue import RevenueService, TariffType
        svc = RevenueService(engine=mock_engine)
