...
class TestReportType:
    def test_monthly_performance(self):
        from services.reporting.models import ReportType
...
class TestSectionType:
    def test_cover(self):
        from services.reporting.models import SectionType
...
class TestReportSection:
    def test_minimal_section(self):
        from services.reporting.models import ReportSection, SectionType
...
class TestReportTemplate:
    def test_minimal_template(self):
        from services.reporting.models import ReportTemplate, ReportType
    ...
    def test_template_with_sections(self):
        from services.reporting.models import ReportTemplate, ReportType, ReportSection, SectionType
        sections = [
