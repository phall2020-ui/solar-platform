...
class TestGapSeverity:
    def test_short_value(self):
        from services.data_quality.gap_detection import GapSeverity
...
class TestClassify:
    def test_short_gap(self):
        from services.data_quality.gap_detection import _classify, GapSeverity
...
class TestGapDetector:
    ...
    def test_detect_gaps_no_readings_table(self, mock_get_engine):
        ...
        from services.data_quality.gap_detection import GapDetector
