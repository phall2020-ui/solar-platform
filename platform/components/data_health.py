...
from services.incremental_etl import IncrementalETL
                ...
                if incremental:
                    ...
                    if validate:
                        ...
                        if not report.is_passed() and block_on_failure:
                            ...
                            from services.db_utils import get_connection as _dh_get_conn
                        ...
                        with _dh_get_conn(db_path) as conn:
                            df.to_sql(table_name, conn, if_exists='replace', index=False)
                        success = True
                        from services.incremental_etl import DataQualityReport
