...
class TestValidationSeverity:
    def test_error_value(self):
        from solar_platform.data_quality.validators import ValidationSeverity
...
class TestValidationResult:
    def test_frozen_dataclass(self):
        from solar_platform.data_quality.validators import ValidationResult, ValidationSeverity
        r = ValidationResult(
            validator_name="test",
...
class TestValidationReport:
    ...
    def test_quality_score_deducts_errors(self):
        from solar_platform.data_quality.validators import ValidationReport, ValidationResult, ValidationSeverity
        report = ValidationReport()
...
class TestCapacityExceedanceValidator:
    def test_within_capacity(self):
        from solar_platform.data_quality.validators import CapacityExceedanceValidator
...
class TestNegativeValueValidator:
    def test_positive_value_passes(self):
        from solar_platform.data_quality.validators import NegativeValueValidator
...
class TestNighttimeGenerationValidator:
    def test_daytime_generation_passes(self):
        from solar_platform.data_quality.validators import NighttimeGenerationValidator
...
class TestStalenessValidator:
    def test_recent_reading_passes(self):
        from solar_platform.data_quality.validators import StalenessValidator
...
class TestRunValidation:
    ...
    def test_catches_validator_exceptions(self):
        from solar_platform.data_quality.validators import run_validation, ReadingValidator, ValidationResult
