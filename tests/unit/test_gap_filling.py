...
class TestFilledReading:
    def test_defaults(self):
        from solar_platform.data_quality.gap_filling import FilledReading
        fr = FilledReading(
...
class TestLinearInterpolation:
    ...
    def test_name(self):
        from solar_platform.data_quality.gap_filling import LinearInterpolation
...
class TestTypicalDayProfile:
    ...
    def test_name(self):
        from solar_platform.data_quality.gap_filling import TypicalDayProfile
